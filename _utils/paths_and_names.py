...
def experiment_writer_path(results_folder, data_name, propensity_model, labeling, partition, settings, pu_method):
    return os.path.join(experiment_method_result_folder_path(results_folder, data_name, propensity_model, labeling, partition, settings, pu_method),"")
    #return os.path.join(results_folder, data_name)    
    # return "/media/mika/Storage/code/sar-pu-test/results/classifier.pt"

def experiment_classifier_path(results_folder, data_name, propensity_model, labeling, partition, settings, pu_method):
    return os.path.join(experiment_method_result_folder_path(results_folder, data_name, propensity_model, labeling, partition, settings, pu_method),"classifier.pt")
    #return os.path.join(results_folder, data_name,"classifier.pt")    
    # return "/media/mika/Storage/code/sar-pu-test/results/classifier.pt"

def experiment_propensity_model_path(results_folder, data_name, propensity_model, labeling, partition, settings, pu_method):
    return os.path.join(experiment_method_result_folder_path(results_folder, data_name, propensity_model, labeling, partition, settings, pu_method),"propensity.pt")
    #return os.path.join(results_folder, data_name, "propensity.pt")
    #return "/media/mika/Storage/code/sar-pu-test/results/propensity.pt"
...
def experiment_results_path(results_folder, data_name, propensity_model, labeling, partition, settings, pu_method):
    ...
    #return os.path.join(results_folder, data_name, "results.csv")
    #return "/media/mika/Storage/code/sar-pu-test/results/results.csv"
